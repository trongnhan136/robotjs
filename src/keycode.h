...
enum _MMKeyCode {
	...
	K_IME_HANGUL = K_NOT_A_KEY,
	K_IME_JUNJA = K_NOT_A_KEY,
	K_IME_FINAL = K_NOT_A_KEY,
	K_IME_KANJI = K_NOT_A_KEY
};
...
enum _MMKeyCode {
	...
	K_IME_HANGUL = VK_HANGUL,
	K_IME_JUNJA = VK_JUNJA,
	K_IME_FINAL = VK_FINAL,
	K_IME_KANJI = VK_KANJI
};
